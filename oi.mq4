...
extern string Symbol1 = "XTIUSD";
extern string Symbol2 = "USDCAD";
extern double smalldollars=200;
extern double bigdollars=200;
extern double dollars=20;
extern int smallmagic=7;
extern int bigmagic=8;
...
{
   OrderSend(Symbol1,OP_SELL,(lots*10),Ask,3,0,0,"Sell",smallmagic,0,Green);
   OrderSend(Symbol2,OP_SELL,lots,Ask,3,0,0,"Sell",bigmagic,0,Green);
   OrderSend(Symbol1,OP_BUY,(lots*10),Bid,3,0,0,"Buy",smallmagic,0,Green);
