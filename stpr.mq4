...
int start() {
   ...
   if ( currentorder(time, TimeCurrent())==1) {
      ...
      if ( OrdersTotal()  == 0 && sig=="BUY" ) f0_3();
      if ( OrdersTotal() == 0 && sig=="SEL") f0_0();
   }
   }
...
void f0_0() {
   ...
   OrderSend(Symbol(), OP_BUY, GVard_128, Ask, 3, 0, 0, "Main BuyeR", GVari_96, 0, Green);
}

// 689C35E4872BA754D7230B8ADAA28E48
void f0_3() {
  
   OrderSend(Symbol(), OP_SELL, GVard_128, Bid, 3, 0, 0, "Main SelleR", GVari_96, 0, Red);
}

// 09CBB5F5CE12C31A043D5C81BF20AA4A
void f0_10() {
  
   OrderSend(Symbol(), OP_BUY, GVard_128, Ask, 3, 0, 0, "Sub BuyeR ", GVari_96, 0, Green);
}

// 689C35E4872BA754D7230B8ADAA28E48
void f0_13() {
  
   OrderSend(Symbol(), OP_SELL, GVard_128, Bid, 3, 0, 0, "Sub SelleR", GVari_96, 0, Red);
}
